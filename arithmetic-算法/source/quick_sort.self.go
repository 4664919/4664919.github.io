...
//	return i
//}
//func (qs *QuickSort) sort(base, i, j int) {
//	//qs.Point("sort once", base, i, j)
//	//func (qs *QuickSort) sort(data []byte, i, j int) {
//	if i >= j {
//		return
//	}
//	var pi int = qs.partition(base, i, j)
//	qs.Point("sort onceA", pi-1, i, pi)
//	qs.Point("sort onceb", pi, pi, j)
//	qs.sort(pi, i, pi)
//	//qs.sort(pi, pi, j)
//}
//
